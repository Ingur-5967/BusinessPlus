...
public class Menu {
    ...
    private final HandlerBusiness handlerBusiness = new HandlerBusiness(Main.getInstance());
    ...
    public void setItems(Player p, Inventory inventory, @NotNull InventoryType type, ItemType... item) {
        ...
        switch (type) {
            ...
            case LOW_CLASS : {
                ...
                for(int i : biz.getListBizId(BusinessClassType.LOW)) {
                    inventory.setItem(getInt("Business.Id." + i + ".Slot"),
                            setItemMeta(config.getItemStack("Business.Id." + i + ".Item"), getStringList("Business.Id." + i + ".Lore"),
            ...
            case DEVELOP_BIZ : {
                for(int i : handlerBusiness.getHaveBusinessId(p)) {
